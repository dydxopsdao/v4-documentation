...
See [here](https://dydx-chain-docs.vercel.app/validators/cosmovisor)  for installation instructions.
...
Releases for the dYdX chain will use [semantic versioning](https://semver.org/). See [here](https://dydx-chain-docs.vercel.app/validators/types_of_upgrades) for details.
